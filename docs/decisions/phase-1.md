...
- Settings groups minimum notice, booking horizon, guest change deadline and daily meeting cap under Booking boundaries. Saved notice/horizon values govern public availability, bookings and rescheduling, including the public week picker and applicable policy copy.
