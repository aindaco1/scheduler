...
| Dust Wave newsletter | Shared defaults; existing opt-out footer connected to a signed branded endpoint; one-click headers; coarse signup throttle and origin checks | Six focused tests and dependency audit pass; [PR #20](https://github.com/aindaco1/dust-wave-new/pull/20); final rollout evidence below |
...
Pending final CI and deployment verification.
