# Pre-1.0 development and verification history

Historical snapshots from September 9–10, 2026. Counts, live versions and pending work below describe each entry at the time; use [current release status](../STATUS.md) for the latest state.
