...
The scoped audit, accepted limitations, and regression commands are in [the quality review](docs/QUALITY.md). Keep `npm run check` and the dependency advisory check green. Do not weaken provider failure handling to improve apparent uptime.
